...
class StripeController extends Controller
{
    ...
    public function transaction_save(Request $request)
    {
        ...
        $trans_check = DB::table('transactions')->where('transaction_id', $paymentIntentID)->first();
        if ($trans_check == null) {
            ...
            if ($transaction) {
                ...
                try {
                    ...
                    return response()->json($paymentIntentID);
                } catch (\Exception $e) {
                    echo ($e->getMessage());
                    return response()->json([
                        'error' => $e->getMessage(),
    ...
    {
        echo ('this is the test schedule');
    }
